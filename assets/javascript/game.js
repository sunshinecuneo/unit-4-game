...
//Associate my num1-4 with each of the crystals.<----done!
//Setup click event so it works with all four crystals.
//loop through images array.
//data attribute<----done---I THINK!!
//add clicked value to playerTotal
